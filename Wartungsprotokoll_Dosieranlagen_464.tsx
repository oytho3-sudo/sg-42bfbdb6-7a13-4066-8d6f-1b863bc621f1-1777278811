...
const translations = {
  ...
  en: {
    ...
    dpFunktion:         'Function',
    dpMenge:            'measured quantity',
    dpDichtigkeit:      'Tightness',
    ...
    p03: 'Suction line: condition, tightness',
    p04: 'Water meter: function, tightness',
    p05: 'Water valve: tightness; check at water meter',
    p06: 'Buffer tank: status and function of the level switches',
    p07: 'Diaphragm pump: torque screws, function, tightness',
    p08: 'Water filter: filter cartridge condition',
    p09: 'Medium lines: control passage hoses, fittings',
    p10: 'Compressed air: tightness, hoses, fittings, filters, oilers',
    p11: 'Drum lid: function and position of the level switches',
    p12: 'Drum lid: function of check valve of suction lance',
    p13: 'Water flow limiter 30 l/min (Kobold)',
  },
  fr: {
    ...
    dpFunktion:         'Fonction',
    dpMenge:            'quantité mesurée',
    dpDichtigkeit:      'Étanchéité',
    ...
    p03: "Conduite d'aspiration : état, étanchéité",
    p04: "Compteur d'eau : fonction, étanchéité",
    p05: "Vanne d'eau : étanchéité ; contrôle au compteur d'eau",
    p06: 'Réservoir tampon : état et fonction des interrupteurs de niveau',
    p07: 'Pompe à membrane : couple des vis, fonction, étanchéité',
    p08: 'Filtre à eau : état de la cartouche filtrante',
    ...
    p11: 'Couvercle de fût : fonction et position des interrupteurs de niveau',
    p12: "Couvercle de fût : fonction de la vanne anti-retour de la lance d'aspiration",
    p13: "Limiteur de débit d'eau 30 l/min (Kobold)",
  },
