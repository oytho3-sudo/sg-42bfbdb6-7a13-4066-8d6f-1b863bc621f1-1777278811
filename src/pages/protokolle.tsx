            ...
            <Card className="hover:shadow-lg transition-shadow">
              <CardHeader>
                <div className="flex items-center gap-4">
                  ...
                  <div className="flex-1">
                    <CardTitle>Wartungsprotokoll Dosieranlagen 464</CardTitle>
                    
                  </div>
                </div>
              </CardHeader>
              <CardContent>
                <Link href="/Wartungsprotokoll_Dosieranlagen_464">
                  <Button className="w-full">
                    Protokoll öffnen
                  </Button>
                </Link>
            ...
            <Card className="hover:shadow-lg transition-shadow">
              <CardHeader>
                <div className="flex items-center gap-4">
                  ...
                  <div className="flex-1">
                    <CardTitle>Wartungsprotokoll Sprühkopf</CardTitle>
                    
                  </div>
                </div>
              </CardHeader>
              <CardContent>
                <Link href="/Wartungsprotokoll_Spruehkopf">
                  <Button className="w-full">
                    Protokoll öffnen
                  </Button>
                </Link>
