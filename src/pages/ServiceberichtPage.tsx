    ...
    <>
      ...
      <div style={{ ...s.body, paddingTop: toolbarH + 12 }} className="print-body">
        <div style={s.container} className="print-container">
          ...
          {/* ── Unterschriften ── */}
          <div className="sig-section" style={{ marginTop: 20, border: '1px solid #000', padding: 10, borderRadius: 4, boxSizing: 'border-box', breakInside: 'avoid', pageBreakInside: 'avoid' }}>
